// Assignment_2 v1: Geometric Shape as Abstract class + Rhombus (2D) + Cube (3D)


/*
- Rhombus → public inheritence; because it is a Geometric Shape (2D)
- Cube → Gemoetric3D Shape + public inheritence


// - Add Rhombus , Cube => shapes (who's parent class)
//     - which type of inheritence I should use?
...
// - in previous example => consider creating constructors in each class that is suitable 

// - turn GeoShape into Abstract class
